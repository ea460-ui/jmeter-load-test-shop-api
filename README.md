...
Сценарий реализован строго по требованиям тестового задания для эндпоинтов `/api/...`.

Если рабочий тестовый стенд недоступен, для технической проверки сценария можно использовать mock-сервер, созданный из OpenAPI YAML. Метрики mock-сервера не являются метриками реального backend-сервиса.
